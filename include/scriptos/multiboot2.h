...
typedef struct multiboot_header_tag_information_request
{
    ...
    u32 size;
    u32 requests[0];
} mb_header_tag_information_request_t;
...
typedef mb_mmap_entry_t mb_mmap_t;
